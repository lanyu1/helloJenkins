...
import com.lanyu.jenkins.hellojenkins.common.utils.HibernateProxyTypeAdapter;
 ...
 *
 * @author lanyu
 * @date 2021年08月11日 10:45
 */
@Slf4j
@RestController
@Api(tags = "部门管理接口")
@RequestMapping("/lanxi/department")
...
public class DepartmentController {
    ...
    public void deleteRecursion(String id, String[] ids) {
        ...
        if (list != null && list.size() > 0) {
            throw new LanXiException("删除失败，包含正被用户使用关联的部门");
        }
        // 获得其父节点
